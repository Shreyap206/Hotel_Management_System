    ...
    <div class="info-card">
        <div class="action-container">
            <div class="search-wrapper">
                ...
                <input type="text" id="searchInput" class="search-bar" placeholder="Search employees by name, job, or email...">
            </div>
        </div>
        ...
        <div class="table-container" id="printable-area">
            <table id="employeeTable">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" style="text-align: center;">No employee records found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
