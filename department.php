    ...
    <div class="info-card">
        <div class="action-container">
            <div class="search-wrapper">
                ...
                <input type="text" id="searchInput" class="search-bar" placeholder="Search departments...">
            </div>
        </div>
                    ...
                    <?php if (!empty($departments)): ?>
                        <?php foreach ($departments as $dept): ?>
                            <tr>
                                ...
                                <td>$<?php echo number_format($dept['budget'], 2); ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="2" style="text-align: center;">No department records found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
